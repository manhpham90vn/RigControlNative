...
typedef struct {
    ...
    /* CLOCK_MONOTONIC (ms) lúc packet của frame này vào decoder — UI đo trễ pipeline desktop
     * (decode + marshal + upload). pts_us dùng đồng hồ THIẾT BỊ nên chỉ so tương đối. */
    int64_t recv_ms;
